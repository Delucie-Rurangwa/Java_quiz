...
public class Main {
    public static void main(String[] args) {
                ...
                System.out.println("--- question1.Vehicle Rental System ---");
                ...
                System.out.println(sampleCar.getBrand() + " question1.Car Cost for 5 days: $" + sampleCar.calculateRentCost(5));
                System.out.println(sampleBike.getBrand() + " question1.Bike Cost for 5 days: $" + sampleBike.calculateRentCost(5));
                System.out.println("-------------------------------------");

                // Dynamic User Input Requirement
                System.out.print("Enter vehicle type (1 for question1.Car, 2 for question1.Bike): ");
                int choice = scanner.nextInt();
                scanner.nextLine();

                System.out.print("Enter question1.Vehicle Brand: ");
        ...
        if (choice == 1) {
                ...
                System.out.println("question1.Vehicle Brand: " + userVehicle.getBrand());
